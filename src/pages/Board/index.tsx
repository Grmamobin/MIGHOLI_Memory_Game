...
function BoardGame(){
    ...
    <div className="background">
        ...
        {gameover && <RestartOrNot statues={'☠️ Ｇａｍｅ ｏｖｅｒ ☠️'} score={score} images={'/images/migholi_background2.svg'} alt_image={'gameover-img'}/> }

        {win && <RestartOrNot statues={'Congrats🏆 You Win 🎯'} score={score} images={'/images/migholi_background.svg'} alt_image={'winning-img'}/> }
